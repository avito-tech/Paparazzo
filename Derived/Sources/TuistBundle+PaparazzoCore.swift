...
/// Since PaparazzoCore is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Paparazzo_PaparazzoCore"
    ...
    fatalError("unable to find bundle named Paparazzo_PaparazzoCore")
}()
}
