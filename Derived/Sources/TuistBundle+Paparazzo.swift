...
/// Since Paparazzo is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Paparazzo_Paparazzo"
    ...
    fatalError("unable to find bundle named Paparazzo_Paparazzo")
}()
}
